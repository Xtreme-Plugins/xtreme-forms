...
class XL_GDPR {
	...
	const RETENTION_CRON_HOOK = 'xl_gdpr_retention_purge';
	 ...
	 *
	 * Removes from:
	 * - leads (wp_xtremeleads_leads)
	 * - notes (wp_xtremeleads_notes)
	 * - lead_tags pivot (wp_xtremeleads_lead_tags)
	 * - email_log (wp_xtremeleads_email_log)
	 * - activity (wp_xtremeleads_activity)
	 *
	...
	public static function delete_leads_cascade( array $lead_ids ): void {
		...
		$tables = array(
			$wpdb->prefix . 'xtremeleads_notes' => 'lead_id',
			$wpdb->prefix . 'xtremeleads_lead_tags' => 'lead_id',
			$wpdb->prefix . 'xtremeleads_email_log' => 'lead_id',
			$wpdb->prefix . 'xtremeleads_activity' => 'lead_id',
		);
