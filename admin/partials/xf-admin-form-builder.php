...
<?php
// Pass form fields data to the builder script (xtremeforms-builder is enqueued
// by enqueue_assets() for new/edit actions on the forms page).
wp_add_inline_script(
	'xtremeforms-builder',
	'var xtremeFormsBuilderData = ' . wp_json_encode(
		array( 'fields' => $fields ),
...
// Form-settings tab/toggle/copy logic — extracted from inline <script>.
wp_enqueue_style(
	'xtremeforms-form-settings',
	XTREMEFORMS_PLUGIN_URL . 'admin/css/xf-form-settings.css',
	array( 'xtremeforms-builder' ),
	XTREMEFORMS_VERSION
);
wp_enqueue_script(
	'xtremeforms-form-settings',
