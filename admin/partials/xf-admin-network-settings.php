...
$network_settings = get_site_option( Xtremeforms_Multisite::NETWORK_SETTINGS_KEY, array() );
	...
	<form method="post" action="<?php echo esc_url( network_admin_url( 'admin-post.php' ) ); ?>">
		...
		<table class="form-table" role="presentation">
			<tr>
				...
				<td>
					<input type="color" id="xf-email-header-color" name="xtremeforms_email_header_color"
			...
			<tr>
				...
				<td>
					<textarea id="xf-email-template-body" name="xtremeforms_email_template_body"
			...
			<tr>
				...
				<td>
					<input type="number" id="xf-retention-days" name="xtremeforms_retention_days"
			...
			<tr>
				...
				<td>
					<label>
						<input type="checkbox" name="xtremeforms_anonymize_ip" value="1" <?php checked( $anonymize_ip ); ?>>
