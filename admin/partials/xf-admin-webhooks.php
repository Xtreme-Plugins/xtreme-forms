...
wp_localize_script(
	...
	array(
		...
		'networkErrorTestFire' => __( 'Network error. Test fire could not be sent.', 'xtreme-forms' ),
		'loading'              => __( 'Loading…', 'xtreme-forms' ),
		'failedToLoadLog'      => __( 'Failed to load log.', 'xtreme-forms' ),
		'noLogEntries'         => __( 'No log entries found.', 'xtreme-forms' ),
		'time'                 => __( 'Time', 'xtreme-forms' ),
		'recipientUrl'         => __( 'Recipient URL', 'xtreme-forms' ),
		'leadId'               => __( 'Lead ID', 'xtreme-forms' ),
		'event'                => __( 'Event', 'xtreme-forms' ),
		'status'               => __( 'Status', 'xtreme-forms' ),
		'httpCode'             => __( 'HTTP Code', 'xtreme-forms' ),
		'retry'                => __( 'Retry?', 'xtreme-forms' ),
		'response'             => __( 'Response', 'xtreme-forms' ),
		'test'                 => __( 'test', 'xtreme-forms' ),
		'retryLabel'           => __( 'Retry', 'xtreme-forms' ),
	)
);
?>
