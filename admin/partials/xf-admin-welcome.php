...
// The welcome page hook (admin_page_xtremeforms-welcome) does not match the
// shared 'xtreme-forms' substring used by the central enqueue filter, so we
// register and enqueue the page-specific stylesheet here.
wp_enqueue_style(
	'xtremeforms-welcome',
