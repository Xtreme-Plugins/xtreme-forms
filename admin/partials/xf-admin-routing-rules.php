...
<?php
/*
 * Routing-rules page bootstrap data + i18n strings.
 *
 * The dedicated JS (admin/js/xf-routing-rules.js) is enqueued via the shared
...
wp_localize_script(
	...
	'xfRoutingRulesI18n',
	array(
		'noRules' => __( 'No routing rules yet. Click "Add Rule" to create one.', 'xtreme-forms' ),
	)
);
