...
<?php
/*
 * Email-templates page i18n strings.
 *
 * The dedicated JS (admin/js/xf-email-templates.js) is enqueued via the shared
...
wp_localize_script(
	'xf-email-templates',
	'xfEmailTemplatesI18n',
	array(
		'invalidFileType' => __( 'Invalid file type. Please upload a JPEG, PNG, GIF, or WebP image.', 'xtreme-forms' ),
		'fileTooLarge'    => __( 'File is too large. Maximum size is 2 MB.', 'xtreme-forms' ),
		'sending'         => __( 'Sending…', 'xtreme-forms' ),
		'testEmailSent'   => __( 'Test email sent.', 'xtreme-forms' ),
		'sendFailed'      => __( 'Send failed.', 'xtreme-forms' ),
